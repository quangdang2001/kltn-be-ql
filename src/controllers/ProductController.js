...
class ProductController {
    ...
    getProductsByCategory = asyncHandler(async(req, res) => {
        ...
        if (mongoose.Types.ObjectId.isValid(subCategoryId)) query.subCategory = subCategoryId;
        if (mongoose.Types.ObjectId.isValid(manufacturerId)) query.manufacturer = manufacturerId;
        console.log(query)
